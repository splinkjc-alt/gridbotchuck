...
class TestGridTradingStrategy:
    ...
    def setup_strategy(self):
        ...
        config_manager.get_mtf_analysis_interval_minutes.return_value = 60
        config_manager.get_mtf_timeframes.return_value = {"trend": "4h", "config": "1h", "execution": "15m"}
    ...
    async def test_initialize_grid_orders_once_first_time(self, setup_strategy):
        ...
        async def sync_balances_side_effect(*args):
            ...
            return True
        balance_tracker.sync_balances_from_exchange = AsyncMock(side_effect=sync_balances_side_effect)
