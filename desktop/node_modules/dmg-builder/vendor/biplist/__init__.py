...
class PlistReader:
    ...
    def readObject(self):
        ...
        # dict
            ...
            raise InvalidPlistException(f"Invalid object found: {{format: {bin(format)}, extra: {bin(extra)}}}")
...
class StringWrapper:
    ...
    def __new__(cls, value):
        ...
        for encoding in ("ascii", "utf_16_be"):
            ...
            if encodedValue is not None:
                if encodedValue not in cls.__instances:
                    cls.__instances[encodedValue] = super().__new__(cls)
        ...
        raise ValueError(f"Unable to get ascii or utf_16_be encoding for {value!r}")
...
class PlistWriter:
    ...
    def wrapRoot(self, root):
        ...
        if isinstance(root, bool):
            result = self.wrappedTrue if root is True else self.wrappedFalse
    ...
    def computeOffsets(self, obj, asReference=False, isRoot=False):
        ...
        if obj is None:
            ...
            raise InvalidPlistException(f"Unknown object type: {type(obj).__name__} ({obj!r})")
    ...
    def writeOffsetTable(self, output):
        ...
        for obj,_order in writtenReferences:
            ...
            if position is None:
                raise InvalidPlistException(f"Error while writing offsets table. Object not found. {obj}")
