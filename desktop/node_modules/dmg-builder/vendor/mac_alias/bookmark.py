...
class Bookmark :
    ...
    def from_bytes(cls, data):
        ...
        while tocoffset != 0:
            ...
            for n in xrange(0,toccount):
                ...
                eid,eoffset,_edummy = struct.unpack(b"<III",
                                                   data[ebase:ebase+12])
    ...
    def to_bytes(self):
        ...
        for ndx,toc in enumerate(tocs):
            tid, data = toc
            next_offset = 0 if ndx == len(tocs) - 1 else offset + 20 + len(data)
    ...
    def __repr__(self):
        ...
        for tid,toc in self.tocs:
            ...
            for k,v in iteritems(toc):
                kf = repr(k) if isinstance(k, (str, unicode)) else f"0x{k:04x}"
